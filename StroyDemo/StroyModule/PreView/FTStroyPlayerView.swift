...
protocol FTPlayerObserver: class {
...
protocol FTPlayerControls: class {
...
class FTStroyPlayerView: UIView {
    ...
    //MARK: - Public Vars
    public weak var playerObserverDelegate: FTPlayerObserver?
...
extension FTStroyPlayerView : FTPlayerControls{
