//
//  FTAnimatedCollectionLayout.swift
//  FTAnimatedCollectionLayout
//
//  Created by Journey on Feb 8, 2020.
...
open class FTAnimatedCollectionLayout: UICollectionViewFlowLayout {
    
    /// The animator that would actually handle the transitions.
    open var animator: FTLayoutAttributesAnimator?
